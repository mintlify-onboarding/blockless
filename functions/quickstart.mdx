---
title: "Getting Started with Blockless Functions"
sidebarTitle: "Quick Start"
description: "This guide will walk you through logging in to the Blockless Network to deploying your first Function."
---

> _**Try the Blockless Dashboard**_
>
>_The quickest way to experiment with Blockless Functions is through the [Blockless Dashboard](https://dashboard.blockless.network/)). The only thing you need is to link your Web3 wallet and GitHub account. After that, you can deploy a sample project to preview and test a Functions script immediately._
...
1. `bls.toml`: Your [Blockless configuration file](/functions/function-manifest).
...
To do more with Blockless Functions, explore the [tutorials](/functions/tutorials).
